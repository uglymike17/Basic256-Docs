...
Устанавливает текущий цвет для операций рисования в значение *имя\_цвета*; или в RGB цвет из компонент *красный*, *синий*, *зеленый*; или в *rgb_значение*. Есть специальный цвет с именем CLEAR и значением -1. Если текущий цвет установлен в это значение, то пикселы или фигуры, рисуемые этим цветом будут стирать пикселы окна графического вывода делая их прозрачными. Это особенно удобно при создании спрайтов через команду Spriteslice.
