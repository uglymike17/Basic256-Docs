...
Ниже приведен список ошибок времени исполнения (runtime) возвращаемый функцией [Lasterror](./lasterror.md) и текстовых сообщений об ошибке, возвращаемых функцией [LastErrorMessage](./lasterrormessage.md).
\<td colspan=“2”\>Номер и код ошибки\<td colspan=“2”\>Описание ошибки\|
