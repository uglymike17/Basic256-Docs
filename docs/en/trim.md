...
**trim** ( [string_expression](./stringexpressions.md) )\
return [string_expression](./stringexpressions.md)

### Description

The **Trim** function removes all whitespace characters from both the beginning and ending of a string.\
[RTrim](./rtrim.md) trims only the right end and [LTrim](./ltrim.md) only trims the left end of the string.
