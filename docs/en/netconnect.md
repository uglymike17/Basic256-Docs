...
**netconnect** ( *server_name*, *port_number* )\
**netconnect** [network_socket_number](./integerexpressions.md), *server_name*, *port_number*\
**netconnect** ( [network_socket_number](./integerexpressions.md), *server_name*, *port_number* )

### Description

Open a network connection (client) to a server. The IP address or host name of a server are specified in the *server_name* argument, and the specific network port number in the *port_number* argument. If [network_socket_number](./integerexpressions.md) is not specified socket number zero (0) will be used.
