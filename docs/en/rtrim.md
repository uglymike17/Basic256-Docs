...
**rtrim** ( [string_expression](./stringexpressions.md) )\
...
[LTrim](./ltrim.md) trims the left end of the string and [Trim](./trim.md) removes all whitespace characters from both the beginning and ending of a string
