...
**right**( [string_expression](./stringexpressions.md), [length_expression](./integerexpressions.md))

returns [string_expression](./stringexpressions.md)

### Description

If length is greater than or equal to zero, returns a portion of the specified [string_expression](./stringexpressions.md), starting from the first character on the right and continuing for [length_expression](./integerexpressions.md) characters. If length is less than zero then remove [length_expression](./integerexpressions.md) characters from the right of the string.
