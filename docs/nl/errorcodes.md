...
Dit is de lijst van de runtime foutcodes die door de [LastError](./lasterror.md) worden teruggegeven. Samen met de code wordt de foutboodscahp ook vermeld.
De boodschap wordt door de [LastErrorMessage](./lasterrormessage.md) functie weergegeven.
...
[vorige](./operators.md) \| [Begin](./start.md) \|
