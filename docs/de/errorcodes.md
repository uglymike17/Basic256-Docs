...
Dies ist eine Liste der Runtime-Error-Codes, welche durch die [LastError](./lasterror.md)-Funktion und der Text-Error Messages durch die [LastErrorMessage](./lasterrormessage.md)-Function mitgeteilt werden.
